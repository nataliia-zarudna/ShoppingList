 ...
 */
public class ProductListsFragmentOld
        extends Fragment
        /*implements
    ...
    /*private static final String TAG = "ProductListsFragmentOld";
    ...
    public static Fragment getInstance() {
        return new ProductListsFragmentOld();
    }
    ...
    private void configCreationMenu() {
        ...
        mCopySubItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                copyListFragment.setTargetFragment(ProductListsFragmentOld.this, REQUEST_CODE_LIST_TO_COPY);
